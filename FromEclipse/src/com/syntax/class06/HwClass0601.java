...
public class HwClass0601 {
	...
	public static void main(String[] args) {
		...
		System.out.println("There is anything on sale ?");
		...
		System.out.println("After discoun "+discount+" the price of the item reduce from "+price+" to "+saved);
